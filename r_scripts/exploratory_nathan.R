...
reading_vs_spending <- read.csv("https://raw.githubusercontent.com/info-201a-au21/final-project-notachevy/main/data/average-reading-performance-in-pisa-and-average-spending-per-student.csv?token=AT6RNREDCEWVW3PEY2SX5OTBYQP2K")
library(dplyr)
